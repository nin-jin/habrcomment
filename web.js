    ...
    class $my_habrcomment_comment extends $.$mol_list {
        ...
        User_link() {
            return ((obj) => {
                ...
                obj.sub = () => [this.User_avatar(), this.User_name()];
                return obj;
            })(new this.$.$mol_link());
        }
        user_link() {
...
(function ($) {
    class $my_habrcomment extends $.$mol_page {
        ...
        Content() {
            return ((obj) => {
                obj.rows = () => [this.Article(), this.Comments()];
                return obj;
            })(new this.$.$mol_list());
        }
        Article() {
        ...
        Comment(id) {
            return ((obj) => {
                ...
                obj.image_uri = (node) => this.image_uri(node);
                return obj;
            })(new this.$.$my_habrcomment_comment());
        }
        comment_time(id) {
            return ((obj) => {
                return obj;
        ...
        plugins() {
            return [this.Theme(), this.Search_key()];
        }
        Theme() {
            return ((obj) => {
                return obj;
...
(function ($) {
    ...
    (function ($$) {
        ...
        class $my_habrcomment extends $.$my_habrcomment {
            ...
            comment_time(id) {
                var _a;
                return (_a = this.comments_data().comments[id].timePublished) !== null && _a !== void 0 ? _a : new $.$mol_time_moment;
            }
            comments(id) {
